  ...
  const handleProceedWithPayment = async (selectedAddress: Address) => {
    ...
    try {
      ...
      if (presentError) {
        ...
        // Manual order creation (fallback for localhost/dev environments where webhooks don't fire)
        try {
          ...
          Sentry.logger.info("Order created manually via client fallback");
        } catch (error) {
          console.error("Manual order creation failed:", error);
          Sentry.logger.error("Manual order creation failed", error);
        }
